...
Description: Solves the tansient stability and times it
...
files = [ "WSCC 9 bus", "ACTIVSg200", "ACTIVSg500", "ACTIVSg2000", "ACTIVSg25k", "ACTIVSg70k" ]
...
# Create a function that the timeit can call that will solve the TS
def solve():
	SimAuto.RunScriptCommand("TSSolveAll;")

# Main function that will run the timeit function on the case
def solve_ts(file_name):

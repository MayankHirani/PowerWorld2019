...
Description: Solves optimal power flow and times it
...
# Create a function that the timeit can call that will solve the optimal power flow
def solve():
	SimAuto.RunScriptCommand('SolvePrimalLP("", "");')

# Main function that will run the timeit function on the case
def solve_primal(file_name):

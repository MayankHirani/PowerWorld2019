...
Script #2: Retrieving and changing elements together
...
# Import pythoncom to use VARIANT
import pythoncom
...
CheckResultForError(SimAuto.OpenCase(file_name + "\\B7FLAT"), "Opened Case")
...
SimAuto.RunScriptCommand('DeleteFile("%s\\B7FLAT");' % file_name)
